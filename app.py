...
SERVICE_ACCOUNT_FILE = os.path.join(os.getcwd(), 'spreedsheet-423616-7b116f800da5.json')  # Correct path to your service account key file  # Correct path to your service account key file
